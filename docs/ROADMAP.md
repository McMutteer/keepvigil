...
- [ ] **L4**: assertText pasa con empty string (`packages/executors/src/browser.ts:124`)
...
- [ ] **L8**: Truncation suffix puede exceder limite (`packages/github/src/services/check-run-updater.ts:31-32`)
- [ ] **L9**: comment-builder usa type assertions inseguros (`packages/github/src/services/comment-builder.ts:108-130`)
- [ ] **L10**: Dockerfile Alpine sin SHA pin (`Dockerfile:1`)
